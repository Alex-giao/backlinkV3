import { loadAccountRecord, saveAccountRecord, } from "./data-store.js";
export async function getAccountForHostname(hostname) {
...
export async function touchAccountUsage(hostname) {
