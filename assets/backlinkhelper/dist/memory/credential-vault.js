...
import { deleteCredentialRecord, loadCredentialRecord, saveCredentialRecord, } from "./data-store.js";
...
export async function putCredential(credentialRef, payload) {
...
export async function getCredential(credentialRef) {
...
export async function deleteCredential(credentialRef) {
