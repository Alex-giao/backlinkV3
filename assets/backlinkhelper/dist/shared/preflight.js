...
function getAlternateLoopbackUrl(cdpUrl) {
...
async function getLoopbackConflictHint(cdpUrl) {
...
async function checkCdpRuntime(cdpUrl) {
    if (!cdpUrl.startsWith("http://") && !cdpUrl.startsWith("https://")) {
        return {
            ok: true,
...
async function checkBrowserUseCli() {
