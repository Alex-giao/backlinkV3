...
import type { FinalizeResult, TakeoverHandoff, TaskRecord, WaitMetadata } from "../shared/types.js";
...
function makeWait(overrides: Partial<WaitMetadata> = {}): WaitMetadata {
  return {
...
function makeHandoff(overrides: Partial<TakeoverHandoff> = {}): TakeoverHandoff {
  return {
