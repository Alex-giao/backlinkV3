...
import type { MissingInputPreflightReport } from "../shared/types.js";

function makeReport(overrides: Partial<MissingInputPreflightReport> = {}): MissingInputPreflightReport {
  return {
