...
import type { FlowFamily, PageAmbiguityFlag, PageAssessment } from "./types.js";

interface InferPageAssessmentArgs {
  url: string;
  title?: string;
  bodyText?: string;
  ...
  authHints?: string[];
  antiBotHints?: string[];
  embedHintsCount?: number;
  visualProbeRecommended?: boolean;
  postClickStateUnclear?: boolean;
...
export function inferPageAssessment(args: InferPageAssessmentArgs): PageAssessment {
  ...
  const ambiguityFlags: PageAmbiguityFlag[] = [];
